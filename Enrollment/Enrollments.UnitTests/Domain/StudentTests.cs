...
public class StudentTests
{
    ...
    public void CreateShouldThrowInvalidAgeExceptionIfUnder18(int age)
    {
        ...
        Assert.Equal(DomainErrors.StudentNotAdult, result.Message); // Asserting exception message is the correct one
    }
    ...
    public void CreateShouldThrowInvalidNameExceptionIfNameIsInvalid(string invalidName)
    {
        ...
        Assert.Equal(DomainErrors.InvalidName(typeof(Student), MinNameLenght), result.Message); // Asserting exception message is the correct one
    }
