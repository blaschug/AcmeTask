...
public class CourseTests
{
    ...
    public void CreateShouldThrowInvalidNameExceptionIfNameIsInvalid(string invalidName)
    {
        ...
        Assert.Equal(DomainErrors.InvalidName(typeof(Course), 3), result.Message); // Asserting exception message is the correct one
    }
    ...
    public void CreateShouldReturnExceptionIfRegistrationFeeIsNegative()
    {
        ...
        // Assert
        Assert.NotNull(result);
        Assert.Equal(DomainErrors.InvalidRegistrationFee, result.Message); // Asserting exception message is the correct one
    }
    ...
    public void CreateCourseWithStartDateInPastShouldReturnError()
    {
        ...
        // Assert
        Assert.NotNull(result);
        Assert.Equal(DomainErrors.StartCourseInPast, result.Message); // Asserting that error message is the correct one.
    }
    ...
    public void CreateCourseWithEndDateBeforeStartDateShouldReturnError()
    {
        ...
        // Assert
        Assert.NotNull(result);
        Assert.Equal(DomainErrors.StartDateBeforeEndDate, result.Message); // Asserting that error message is the correct one.
    }
